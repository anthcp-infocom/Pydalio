...
from ......io.k8s.api.core import v1 as v1_2
from ......io.k8s.api.rbac import v1 as v1_1
...
class ServiceAccountReference(BaseModel):
    name: str = Field(..., description='Name is the name of the service account.')
    namespace: str = Field(
        ...,
...
class ServiceAccountRestriction(BaseModel):
    namespaces: List[str] = Field(
        ..., description='Namespaces specifies a list of literal namespace names.'
    )
    serviceaccounts: List[ServiceAccountReference] = Field(
        ...,
...
class GroupRestriction(BaseModel):
    ...
    labels: List[v1.LabelSelector] = Field(
        ...,
...
class ClusterRole(BaseModel):
    aggregationRule: Optional[v1_1.AggregationRule] = Field(
        None,
...
class ClusterRoleBinding(BaseModel):
    ...
    roleRef: v1_2.ObjectReference = Field(
        ...,
    ...
    subjects: List[v1_2.ObjectReference] = Field(
        ...,
...
class RoleBindingRestrictionSpec(BaseModel):
    grouprestriction: GroupRestriction = Field(
        ..., description='GroupRestriction matches against group subjects.'
    )
    serviceaccountrestriction: ServiceAccountRestriction = Field(
        ...,
        description='ServiceAccountRestriction matches against service-account subjects.',
    )
    userrestriction: UserRestriction = Field(
...
class RoleBindingRestriction(BaseModel):
    ...
    spec: RoleBindingRestrictionSpec = Field(
