...
class ConfigMapKeySelector(BaseModel):
    ...
    optional: Optional[bool] = Field(
        None, description="Specify whether the ConfigMap or it's key must be defined"
    )
...
class ContainerPort(BaseModel):
    ...
    protocol: Optional[str] = Field(
        None, description='Protocol for port. Must be UDP or TCP. Defaults to "TCP".'
    )
...
class SecretKeySelector(BaseModel):
    ...
    optional: Optional[bool] = Field(
        None, description="Specify whether the Secret or it's key must be defined"
    )
...
class SecretVolumeSource(BaseModel):
    ...
    optional: Optional[bool] = Field(
        None, description="Specify whether the Secret or it's keys must be defined"
    )
...
class ConfigMapProjection(BaseModel):
    ...
    optional: Optional[bool] = Field(
        None, description="Specify whether the ConfigMap or it's keys must be defined"
    )
...
class EventSeries(BaseModel):
    ...
    state: Optional[str] = Field(
        None, description='State of this Series: Ongoing or Finished'
    )
